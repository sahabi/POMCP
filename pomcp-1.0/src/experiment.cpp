...
:   NumRuns(100),//it was 1000
    NumSteps(100000),//it was 100000
    SimSteps(1000),//it was 1000
    TimeOut(36000),
    MinDoubles(0),
    MaxDoubles(20),
    TransformDoubles(-4),
    TransformAttempts(1000),
    Accuracy(0.001),//it was 0.01
    UndiscountedHorizon(10000),//it was 1000
